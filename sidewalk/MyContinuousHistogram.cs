...
namespace Sidewalk
{
    public class MyContinuousHistogram
    {
        private int[] values;
        private Range range;
        ...
        /// </see></summary>
        ///
        /// <param name="values">Values of the histogram
        /// <param name="range">Range of random values
        ///
        public MyContinuousHistogram(int[] values, Range range)
        {
        ...
        /// </summary>
        ///
        /// <param name="percent">Values percentage around median
        ///
